...
<div id="overlay" <?php print $attributes; ?>>
  <div id="overlay-titlebar" class="clearfix">
    ...
    <div id="overlay-close-wrapper">
      <a id="overlay-close" href="#" class="overlay-close c44icon-"><span class="element-invisible"><?php print t('Close overlay'); ?></span></a>
    </div>
    <?php if ($tabs): ?><h2 class="element-invisible"><?php print t('Primary tabs'); ?></h2><ul id="overlay-tabs" class='btn-group pull-right'><?php print render($tabs); ?></ul><?php endif; ?>
  </div>

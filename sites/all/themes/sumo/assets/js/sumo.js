...
// Drupal.theme.prototype.logosumoExampleButton = function (path, title) {
 ...
 */
// Drupal.behaviors.logosumoExampleBehavior = {
...
//       var $anchor = Drupal.theme('logosumoExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
// 
...
Drupal.behaviors.logosumoEqualizer = {
  attach: function (context, settings) {
	// Apply equalizer to wrapper
	$('.view-brand-filter .view-content').equalizer({
		breakpoint : 500,       // if browser less than this width, disable the plugin
		columns    : '.views-row .row-wrapper',
...
// Clears the chosen field
//  $('.chosen-container li.search-choice').remove();
